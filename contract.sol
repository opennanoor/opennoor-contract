// SPDX-License-Identifier: MIT Dylan en faze33fffr  fesfesfggggf
...
contract Openthenoor is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Openthenoor";
    string constant _symbol = "door";
